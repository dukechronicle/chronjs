...
/**
	 * Creates new instance of function ArticleParser called parser
	 * Checks to see if parser returns an error
	 * If yes, outputs an error message "Error adding article" and displays the article's title
	 * If no, appends the url and id of the .xml file from parser to article.url and article.id respectively
	 * Then exports the article
	 * Returns the number of times it succeeds and fails to export articles
	 * @this{runExporter}
	 * @param{zipPath, exportCallback} zipPath holds the path of the zip file while exportCallback returns failures and successes
	 */
