...
exports.siteInit = function (app) {
    ...
    app.get('/sitemaps/full', sitemap.fullIndex);
    app.get('/sitemaps/full/:id', sitemap.show);
    app.get('/sitemaps/news', sitemap.newsIndex);
    app.get('/sitemaps/news/:id', sitemap.show);
